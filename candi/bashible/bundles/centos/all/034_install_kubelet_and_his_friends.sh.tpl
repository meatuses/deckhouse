...
bb-rp-install "kubernetes-cni:{{ index .images.registrypackages (printf "kubernetesCniCentos%s" $kubernetesCniVersion) | toString }}" "kubectl:{{ index .images.registrypackages (printf "kubectl%s" $kubernetesVersion) | toString }}"
...
bb-rp-install "kubelet:{{ index .images.registrypackages (printf "kubeletCentos%s" $kubernetesVersion) | toString }}"
